...
<body>
    <main>
        <div class="container ref min-vh-100">
            ...
            <h3 class="fw-bold mt-4">Health Provider</h3>
            <div class="card">
                <?php
                ...
                ?>
                <form action="../manipulations/health-provider-signup-check.php" method="POST" class="mb-4">
                    <div class="w-100">
                ...
                <div class="container d-flex justify-content-center flex-column">
                    <p>Has an existing account? <strong><a href="health-provider-login.php">Login here.</a></strong></p>
                </div>
            </div>
        </div>
    </main>
